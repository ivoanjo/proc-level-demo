...
int update_and_fork(void) {
  ...
  otel_process_ctx_data update_data = {
    ...
    .host_name = "my-host-updated",
    .service_instance_id = "runtime-456",
  ...
  if (fork() == 0) {
    ...
    otel_process_ctx_data child_data = {
      .deployment_environment_name = "staging",
      .host_name = "my-host-forked",
      .service_instance_id = "runtime-id-forked",
...
int main(int argc, char* argv[]) {
  ...
  otel_process_ctx_data data = {
    ...
    .host_name = "my-host",
    .service_instance_id = "runtime-123",
